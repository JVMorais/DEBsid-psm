...
tol_alfa    = 10^-7;  % Lowest value allowed for the mesh size parameter.
                      %                        
stop_fevals = 0;      % 0-1 variable: 1 if the stopping criterion is based on a 
                      % maximum number of function evaluations; 0 otherwise.
%fevals_max  = max(2000, 2000*n);   % Maximum number of function evaluations allowed.
                      %
...
iter_max    = 500;   % Maximum number of iterations allowed.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mesh size parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
alfa  = 0.05; %max(1,norm(x_initial,inf));  % Initial mesh parameter value 
                                     % (set as in Moré and Wild).
phi   = 1;                           % Coefficient for mesh expansion.
theta = 0.25;                         % Coefficient for mesh contraction.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
