...
# 1 "dgqt.f"
      subroutine dgqt(n,a,lda,b,delta,rtol,atol,itmax,par,f,x,info,iter,
     +                z,wa1,wa2)
...
c       LAPACK  .........  dpotrf
c
c       Level 1 BLAS  ...  dasum, daxpy, dcopy, ddot, dnrm2, dscal
c
c       Level 2 BLAS  ...  dtrmv, dtrsv
c
c     MINPACK-2 Project. July 1994.
...
c        Safeguard par.
     ...
     +       sqrt(parl/paru))*paru
c        write (2,1000) parl,paru,pars,par
c1000    format(4d12.3)
